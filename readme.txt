...
1. Upload the DX Remove Unused Custom Fields plugin to your blog and activate it.
2. Go to Settings -> Remove Unused CFs
3. Click 'Delete' to drop the unrelated fields.
